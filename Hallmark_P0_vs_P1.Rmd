...
df = read.csv("~/Downloads/results/all/comparisons/group_P1_3D_vs_P0_2D_Wald.csv", header=TRUE)
...
```{r}
gse_res <- gse@result
write.csv(gse_res, "~/Desktop/OV90_gse_0_vs_1_1k_perm_pval_1_cutoff_BH.csv")
```
