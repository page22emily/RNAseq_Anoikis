...
#SBATCH --job-name=STARCAOV3_P6 #THIS IS THE ONLYT PART OF THIS YOU CHANGE 
#SBATCH --mem-per-cpu=180000 
#SBATCH --nodes=5
#SBATCH --time=30:00:00  
#SBATCH --share 
#SBATCH --partition=medium
#SBATCH --error=STARCAOV3_P6.err.txt
#SBATCH --output=STARCAOV3_P6.out.txt
