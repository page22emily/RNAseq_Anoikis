...
df = read.csv("~/Desktop/CAOV3_Outputs/results_1_vs_0_CAOV3.csv", header=TRUE)
...
```{r}
gse_res <- gse@result
write.csv(gse_res, "~/Desktop/CAOV3_gse_1_vs_0_1k_perm_pval_1_cutoff_BH.csv")
```
...
```{r}
require(DOSE)
dotplot(gse, showCategory=30, split=".sign") + facet_grid(.~.sign) + theme(axis.text.y = element_text(size = 4)) 
```
