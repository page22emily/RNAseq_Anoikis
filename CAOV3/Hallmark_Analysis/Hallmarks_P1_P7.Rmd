...
df = read.csv("~/Desktop/CAOV3_Outputs/results_7_vs_1_CAOV3.csv", header=TRUE)
...
```{r}
gse_res <- gse@result
write.csv(gse_res, "~/Desktop/CAOV3_gse_7_vs_1_1k_perm_pval_1_cutoff_BH.csv")
```
