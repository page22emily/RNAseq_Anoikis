...
```{r message= FALSE, warning= FALSE, echo=FALSE}
dir <- "~/Documents/Mythreye_Lab/quants_CAOV3_k31/"  #this is a path that you will change. This is the quants folder from Salmon that should be locally on your computer 
samples <- read.csv(file= "~/Documents/Mythreye_Lab/anoikis/CAOV3/meta_CAOV3.csv") #CSV is a metadata file. A sample of this file is on github 
...
```{r message= FALSE, warning= FALSE, echo=FALSE}
sample_meta_data <- read.csv(file= "~/Documents/Mythreye_Lab/anoikis/CAOV3/meta_CAOV3.csv") #this is a DIFFERENT meta data file. Example in github. Include any information in this that you want to compare between samples
...
write.csv(counts, "~/Documents/Mythreye_Lab/anoikis/CAOV3/results/counts_CAOV3.csv")
```
