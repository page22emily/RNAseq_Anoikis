...
```{r}
P0_P1 <- read.csv("~/Documents/Mythreye_Lab/anoikis/CAOV3/results/results_0_vs_1_CAOV3.csv")
P0_P6 <- read.csv("~/Documents/Mythreye_Lab/anoikis/CAOV3/results/results_0_vs_6_CAOV3.csv")
P0_P7 <- read.csv("~/Documents/Mythreye_Lab/anoikis/CAOV3/results/results_0_vs_7_CAOV3.csv")
...
Heatmap(mat_num4, col = coul, cluster_columns = FALSE, row_names_gp = gpar(fontsize = 4), use_raster= FALSE)
```