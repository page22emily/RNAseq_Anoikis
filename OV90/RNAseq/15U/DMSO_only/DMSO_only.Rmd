...
samples <- read.csv(file= "C:/Users/empage/Documents/Lab_Stuff/Anoikis/OV90/treatment_15U/meta_DMSO.csv") 
...
```{r message= FALSE, warning= FALSE, echo=FALSE}
sample_meta_data <- read.csv(file= "C:/Users/empage/Documents/Lab_Stuff/Anoikis/OV90/treatment_15U/meta_DMSO.csv") 
...
write.csv(counts, "~/RNAseq_Anoikis/OV90/RNAseq/15U/counts_15_DMSO_only.csv")
```
...
```{r}
write.csv(res, "~/RNAseq_Anoikis/OV90/RNAseq/15U/res_P1_vs_P0_DMSO.csv")
```
