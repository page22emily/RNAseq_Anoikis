...
```{r}
res7_adj2 <- res_7[res_7$padj <= .05 & res_7$log2FoldChange >= 1.5, ]
res7_adj3 <- res_7[res_7$padj <= .05 & res_7$log2FoldChange <= -1.5, ]

res8_adj2 <- res_8[res_8$padj <= .05 & res_8$log2FoldChange >= 1.5, ]
res8_adj3 <- res_8[res_8$padj <= .05 & res_8$log2FoldChange <= -1.5, ]

res9_adj2 <- res_9[res_9$padj <= .05 & res_9$log2FoldChange >= 1.5, ]
res9_adj3 <- res_9[res_9$padj <= .05 & res_9$log2FoldChange <= -1.5, ]
```
