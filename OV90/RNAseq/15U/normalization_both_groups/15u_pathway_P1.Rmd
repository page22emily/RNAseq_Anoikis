...
df = read.csv("~/RNAseq_Anoikis/OV90/RNAseq/15U/P1_15U_vs_P1_DMSO.csv", header=TRUE)
...
```{r}
gse_res <- gse@result
write.csv(gse_res, "~/Desktop/OV90_15U_gse_P1_15U_vs_DMSO_1k_perm_pval_1_cutoff_BH.csv")
```
