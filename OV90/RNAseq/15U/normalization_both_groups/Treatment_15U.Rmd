...
```{r message= FALSE, warning= FALSE, echo=FALSE}
sample_meta_data <- read.csv(file= "~/Desktop/meta_15U.csv") 
sampleFiles <- sample_meta_data$Sample_ID
...
write.csv(res, "~/RNAseq_Anoikis/OV90/RNAseq/15U/normalization_both_groups/res/P0_P1_15U.csv")
```
...
```{r}
res_2 <- results(dds, contrast=c("condition","P11_15U", "P0_15U"))
...
```{r}
res_3 <- results(dds, contrast=c("condition","P11_15U","P1_15U"))
...
```{r}
res_4 <- results(dds, contrast=c("condition","P11_DMSO","P1_DMSO"))
summary(res_4)
...
```{r}
res_5 <- results(dds, contrast=c("condition", "P11_DMSO", "P0_DMSO"))
summary(res_5)
...
```{r}
res_9 <- results(dds, contrast=c("condition","P11_15U","P11_DMSO"))
summary(res_9)
...
summary(res_10)
write.csv(res_10, "~/RNAseq_Anoikis/OV90/RNAseq/15U/normalization_both_groups/res/P1_15U_P0_DMSO.csv")
```
