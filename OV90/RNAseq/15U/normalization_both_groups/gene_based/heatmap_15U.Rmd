...
Heatmap(mat_3, col=coul, cluster_columns = TRUE, use_raster= TRUE)
```
```{r}
ggplot(data = combined, aes(x = P0_15U_LFC, y = P1_15U_LFC)) + geom_point(alpha = 0.5, size=9, stroke=1.4) + geom_vline(xintercept = 0, 
...
ggsave("~/Desktop/P0_P1_15U.tiff", plot = last_plot(), width= 49, height= 30, unit= "in") 
```
```
