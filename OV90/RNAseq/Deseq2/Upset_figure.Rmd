...
ggsave("~/Desktop/Up_OV90_fullset.tiff", last_plot())
```
...
ggsave("~/Desktop/Down_OV90_fullset.tiff", last_plot())
```
...
ggsave("~/Desktop/NC_OV90_fullset.tiff", last_plot())
```
...
```{r}
upset(up, Group, min_degree=1,sort_sets= FALSE, sort_intersections_by='degree', sort_intersections= "ascending") + ggtitle('Up Regulated Genes') 
ggsave("~/Desktop/Up_OV90_no_P4set.tiff", last_plot())
```

```{r}
upset(down, Group,  min_degree=1, sort_sets= FALSE, sort_intersections_by='degree', sort_intersections= "ascending") + ggtitle("Down Regulated Genes")
ggsave("~/Desktop/Down_OV90_no_P4set.tiff", last_plot())
```

```{r}
upset(nc, Group, min_degree=1, sort_sets= FALSE, sort_intersections_by='degree', sort_intersections= "ascending") + ggtitle("Genes with No Significant Change")
ggsave("~/Desktop/NC_OV90_no_P4set.tiff", last_plot())
```
...
```{r}
upset(up, Group, min_degree=1,sort_sets= FALSE, sort_intersections_by='degree', sort_intersections= "ascending", base_annotations= list('Size'=(intersection_size(counts=FALSE)))) + ggtitle('Up Regulated Genes') 
ggsave("~/Desktop/Up_OV90_no_P4set_no_labels.tiff", last_plot())
```

```{r}
upset(down, Group,  min_degree=1, sort_sets= FALSE, sort_intersections_by='degree', sort_intersections= "ascending", base_annotations= list('Size'=(intersection_size(counts=FALSE)))) + ggtitle("Down Regulated Genes")
ggsave("~/Desktop/Down_OV90_no_P4set_no_labels.tiff", last_plot())
```

```{r}
upset(nc, Group, min_degree=1, sort_sets= FALSE, sort_intersections_by='degree', sort_intersections= "ascending", base_annotations= list('Size'=(intersection_size(counts=FALSE)))) + ggtitle("Genes with No Significant Change")
ggsave("~/Desktop/NC_OV90_no_P4set_no_labels.tiff", last_plot())
```
