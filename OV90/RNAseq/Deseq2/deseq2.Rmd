...
```{r message= FALSE, warning= FALSE, echo=FALSE}
sample_meta_data <- read.csv(file= "~/Documents/Mythreye_Lab/Anoikis_Project/Mehri_Resha/anoikis/meta_data_anoikis.csv") #this is a DIFFERENT meta data file. Example in github. Include any information in this that you want to compare between samples
...
```{r}
data <- read.csv("/Users/emilypage/Documents/Mythreye_Lab/Anoikis_Project/Mehri_Resha/anoikis/raw_counts_edited.csv")
