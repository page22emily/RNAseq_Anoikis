...
```{r}
write.csv (gsva.es, "~/Desktop/Ov90_Hallmarks_res_GSVA.csv")
```

#heatmap to show the scores 
```{r}
data <- gsva.es[ , c(1:6, 10:18)]
```
...
pdf("C:/Users/empage/Documents/heatmap_hallmarks_Ov90.pdf",width=8, height=11)
Heatmap(data, col = coul2, cluster_columns = FALSE, row_names_gp = gpar(fontsize = 8), heatmap_legend_param = list(title = " "))
dev.off()
```
