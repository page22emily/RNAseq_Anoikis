...
df = read.csv("~/Desktop/OV90_Outputs/P7_vs_P0.csv", header=TRUE)
...
```{r}
gse_res <- gse@result
write.csv(gse_res, "~/Desktop/OV90_gse_7_vs_1_1k_perm_pval_1_cutoff_BH.csv")
```
...
```{r}
cnetplot(gse, categorySize="pvalue", foldChange=gene_list, showCategory = 20,  node_label= "category", cex_label_category=0.4)
```
