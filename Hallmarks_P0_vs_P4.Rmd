...
df = read.csv("~/Downloads/results/all/comparisons/group_P4_3D_vs_P0_2D_Wald.csv", header=TRUE)
# we want the log2 fold change 
original_gene_list <- df$log2FoldChange

#list needs no decimal points
no_decimals <- gsub('\\.[0-9]*$','', df$gene_id)
...
```{r}
gse_res <- gse@result
write.csv(gse_res, "~/Desktop/OV90_gse_0_vs_4_1k_perm_pval_1_cutoff_BH.csv")
```
...
g <- cnetplot(gse, categorySize="pvalue", foldChange=gene_list, showCategory = 10, node_label= "category", cex_label_category=0.5) 
g 
```
